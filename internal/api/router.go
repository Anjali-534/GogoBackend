...
func SetupRouter(cfg *config.Config) *gin.Engine {
	...
	gogooPublic := router.Group("/gogoo")
	{
		...
		gogooPublic.GET("/ambulance/ngos/public", handlers.GetPublicNGOs)
	...
	gogoo.Use(middleware.AuthMiddleware())
	{
		...
		gogoo.GET("/tracker/orders/:id/documents", middleware.RequireTrackerCompany(), handlers.ListTrackerOrderDocuments)
		gogoo.DELETE("/tracker/orders/:id/documents/:docId", middleware.RequireTrackerCompany(), handlers.DeleteTrackerOrderDocument)
		gogoo.POST("/tracker/orders/:id/creation-email", middleware.RequireTrackerCompany(), handlers.SendTrackerOrderCreationEmail)
		...
		gogoo.GET("/tracker/staff", middleware.RequireTrackerCompany(), middleware.RequireTrackerOwner(), handlers.ListTrackerStaffUsers)
		...
		gogoo.GET("/support/stats", middleware.RequirePanel("support"), handlers.GetSupportStats)
